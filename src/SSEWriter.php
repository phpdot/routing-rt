...
/**
 * Writes Server-Sent Events to a client connection through write/close callbacks.
 *
...
final class SSEWriter
{
    ...
    /**
     * Wire the writer to its underlying write and close callbacks.
     *
    ...
    /**
     * Mark the stream closed so subsequent writes become no-ops.
     *
